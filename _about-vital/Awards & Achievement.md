...
.column {
    float: left;
    width: 31%; /* Slightly reduced to accommodate margins */
    padding: 3px;
    border: 5px solid #243588;
    border-padding: 10px;
    margin-right: 2%; /* Add space between columns */
    margin-bottom: 20px; /* Add space between rows for mobile layout */
}
.row:after {
    content: "";
    display: table;
...
<div class="row">
    ...
    <div class="column">
        <h3><u><center><b>2025</b></center></u></h3>
        <ul>
            <li>GovInsider Festival of Innovation Awards 2025 - Digital Government Award</li>
					  <li>GovInsider Festival of Innovation Awards 2025 - Transformative Agency of the Year Award (Special Mention)</li>
        </ul>
    </div>
    <div class="column">
