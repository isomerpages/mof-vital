...
<div class="training">
	...
	<div class="row">
		<div class="column">
			<p style="transform: translateY(50px); font-size: 20px;"><b>Track record of delivering courses attended by participants from government agencies</b></p>
		</div>
		<div class="column">
			<p style="transform: translateY(50px); font-size: 20px;"><b>Track record of qualified trainers with qualification in training delivery or teaching</b></p>
		</div>
	</div>&nbsp;
	<div class="row">
		<div class="column">
			<p style="transform: translateY(50px); font-size: 20px;"><b>Registered business entity with ACRA</b></p>
		</div>
		<div class="column">
			<p style="transform: translateY(50px); font-size: 20px;"><b>Sound financial health</b></p>
		</div>
	</div>
